...
include("../require/validate-user.inc.php");
	...
	function uploadNews()
	{
		mysql_query("INSERT INTO `update_detail`(`PublishDate`, `UpdateType`, `ContentType`, `Updates`, `UploadDate`, `UploadBy`, `IsActive`)VALUES('".$_POST['TXT_EventDt']."','news','text','".$_POST['MTXT_UpdateData']."','".date('Y-m-d')."','".$_SESSION['username']."','1')")or die (mysql_error());
...
<!-- /.navbar -->
                ...
                <!-- ."main-bar -->
                    <div class="main-bar">
                        <h3><i class="fa fa-calendar"> </i> Create a Scrolling Update</h3>
                  </div>
                    <!-- /.main-bar -->
            </header>
                <!-- end header.head -->
                      ...
                      <div class="col-lg-6">
                       <div class="box">
                        ...
                        <h5>Scrolling Update List</h5>
						 ...
						 <?php
                          $res_NoticeList=mysql_query("SELECT * FROM `update_detail` WHERE `UpdateType`='news'");
                          $slid=1;
                          while($row_NoticeLIst=mysql_fetch_array($res_NoticeList))
                          {
                          ?>
                          <tr>
                          <td width="70%" colspan="2" align="left"><?php echo $row_NoticeLIst['Updates']; ?></td>
                          <td width="20%" colspan="2" align="center"><?php echo $row_NoticeLIst['UploadDate']; ?></td>
                          
                          <td width="5%" align="center"><a href="Edt_NoticeUpdate.php?id=<?php echo $row_NoticeLIst['Notice_ID']; ?>" class="text-info"><i class="fa fa-pencil-square-o"></i>&nbsp;</a></td>
