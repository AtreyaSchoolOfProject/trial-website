...
include("../require/validate-user.inc.php");
	...
	function updateNotice()
	{
		...
		mysql_query("UPDATE `update_detail` SET `PublishDate`='".$_POST['TXT_EventDt']."', `Updates` = '".$_POST['MTXT_UpdateData']."', `UploadDate` = '".date('Y-m-d')."', `UploadBy`='".$_SESSION['username']."' WHERE `Notice_ID` = '".$_GET['id']."'");
		return $event_id;
	}
