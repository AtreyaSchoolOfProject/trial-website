                    ...
                    <div class="row">
                      <form id="form1" name="form1" method="post" action="">
                        <div class="col-lg-12">
                          <div class="box">
                            <header class="dark">
                              <div class="icons"><i class="fa  fa fa-envelope fa-2x"></i></div>
                              <h5><?php echo $heading ?> Mails</h5>
                            </header>
                            <div style="height: auto;" id="stripedTable" class="body in">
                              <div class="toolbar" style="padding-top: 7px;">
                                <input name="BTN_Mail_Delete1" class="btn btn-danger" type="submit" id="BTN_Mail_Delete1" onclick="return confirm('Do you want to delete the selected query(s)')" value="Delete" />
                          <span class="fc-border-separate" style="width: 3%; display: inline-block"></span> 
                          <a href="MailViewList.php" class="btn-sm btn-primary"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;All</a>
                           <a href="?type=1" class="btn-sm btn-default"><i class="fa fa-plus"></i>&nbsp;&nbsp;New</a> 
                           <a href="?type=2" class="btn-sm btn-success"><i class="glyphicon  glyphicon-ok"></i>&nbsp;&nbsp;Read</a></div>
                              <hr />
