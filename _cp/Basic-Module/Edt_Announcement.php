...
include("../require/validate-user.inc.php");
	...
	function updateAnnounce()
	{
		...
		mysql_query("UPDATE `update_detail` SET `PublishDate`='".$_POST['TXT_EventDt']."', `Heading`='".$heading."', `Updates` = '".$_POST['MTXT_UpdateData']."', `UploadDate` = timestamp(now()), `UploadBy`='".$_SESSION['username']."' WHERE `Notice_ID` = '".$_GET['id']."'");
		return $event_id;
	}
...
<!-- /.navbar -->
                ...
                <!-- ."main-bar -->
                    <div class="main-bar">
                        <h3><i class="fa fa-calendar"></i> Edit Scrolling Notice</h3>
                  </div>
                    <!-- /.main-bar -->
            </header>
                <!-- end header.head -->
                       ...
                       <div class="box">
                        ...
                        <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                	<div class="col-lg-5">
                                    <input type="text" class="validate[required] form-control" name="TXT_EventDt" id="TXT_EventDt" value="<?php echo $row_NoticeUpdate['PublishDate']; ?>" placeholder="Publish Date"/>
                                  	</div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <input type="text" class="validate[required] form-control" name="TXT_Head" id="TXT_Head" placeholder="Headline" value="<?php echo $row_NoticeUpdate['Heading']; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                	<div class="col-lg-12">
                                		<textarea name="MTXT_UpdateData" id="MTXT_UpdateData" class="validate[required] form-control" placeholder="Write your news..."><?php echo $row_NoticeUpdate['Updates']; ?></textarea>
                                    </div>
                                </div>
                      ...
                      <div class="col-lg-6">
                       <div class="box">
                        ...
                        <h5>Scrolling Notice List</h5>
						 ...
						 <?php
                          $res_NoticeList=mysql_query("SELECT * FROM `update_detail` WHERE `UpdateType`='announcement' AND  `IsActive`='1' ORDER BY `UploadDate` DESC");
                          $slid=1;
                          ...
                          <tr>
                          <td width="70%" colspan="2" align="left"><?php echo html_entity_decode($row_NoticeLIst['Heading']); ?></td>
                          <td width="20%" colspan="2" align="center"><?php echo $row_NoticeLIst['PublishDate']; ?></td>
                          
                          <td width="5%" align="center"><a href="Edt_Announcement.php?id=<?php echo $row_NoticeLIst['Notice_ID']; ?>" class="text-info"><i class="fa fa-pencil-square-o"></i>&nbsp;</a></td>
...
<script src="../assets/lib/datepicker/js/bootstrap-datepicker.js"></script> 
        ...
        $(function() {
            // Bootstrap
            $( 'textarea#MTXT_UpdateData' ).ckeditor({width:'98%', height: '150px', toolbar: [
