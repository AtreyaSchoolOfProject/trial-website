                  ...
                  <div class="inner">
                    <div class="row">
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                <label class="control-label col-lg-3">Name</label><div class="col-lg-9">
                                  ...
                                  <input type="text" class="validate[required] form-control" name="TXT_AlbNm" id="TXT_AlbNm" />
                                </div>
                              </div>
                              <div class="form-group">
                      ...
                      <div class="box">
                          ...
                          <td>
                         <?php 
						 	$res_albList = mysql_query("SELECT * FROM `album_name` WHERE `AN_OI_OrganisationID` = '".$_SESSION['OI_OrganisationID']."'");
                         ...
                         <td height="120" colspan="2" align="center">
                          <a href="Alb_UplImg2.php?alb=<?php echo $row_albList['AN_ID']; ?>"><img src="../../Upl_Images/Gallery/Thumbnail/<?php echo $row_albList['AN_Image']; ?>" class="img-responsive" style="margin-bottom: 2px;" alt="<?php echo $row_albList['AN_Name']; ?>" title="<?php echo $row_albList['AN_Name'];?>" /></a>
                          </td>
