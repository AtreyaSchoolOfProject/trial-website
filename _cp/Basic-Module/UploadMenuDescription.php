...
$get_event = urldecode($_SESSION['menuNm']);
...
<!-- /.navbar -->
                ...
                <!-- ."main-bar -->
                    <div class="main-bar">
                        <h3><i class="fa fa-info"></i> Add More Menu Info.</h3>
                  </div>
                    <!-- /.main-bar -->
            </header>
                <!-- end header.head -->
                                	...
                                	<ul class="nav navbar-nav">
                                    	<?php 
											foreach($menu as $i => $m)
											{
												...
												if(mysql_num_rows($res_checkMenu) == 0)
													continue;
																?>
					  ...
					  ?>
                         <div class="body">
                             ...
                             <div class="form-group">
                               ...
                               <div class="col-lg-5" style="padding-top: 7px;"><strong><?php echo urldecode($_GET['menuNm']); ?></strong></div>
                             </div>
                             <div class="form-group">
    ...
    Image</label>
                           ...
                           <input type="submit" name="BTN_Upl_EventCont" id="BTN_Upl_EventCont" value="Save" class="btn btn-primary col-lg-2" />
                           <label class="col-lg-1"></label>
                            <a class="btn btn-warning col-lg-2" style="padding:4px 0px 4px 0px" href="ListEvents.php">Click To Back</a>
                          </div>
...
&new_position=">Change</a> 
                            ...
                            <a href="UpdateMenu.php?event_id=<?php echo $event_row['LE_Slno']; ?>&amp;contid=<?php echo $row_eventData['LE_C_Slno']; ?>" style="padding-right: 20px;"><i class="fa fa-pencil-square-o fa-2x"></i></a>
