...
include("../require/validate-user.inc.php");
	...
	function uploadNews()
	{
		...
		mysql_query("INSERT INTO `update_detail`(`PublishDate`, `UpdateType`, `ContentType`, `Heading`, `Updates`, `UploadDate`, `UploadBy`, `IsActive`)VALUES('".$_POST['TXT_EventDt']."','announcement','text', '".$heading."','".$_POST['MTXT_UpdateData']."',timestamp(now()),'".$_SESSION['username']."','1')")or die (mysql_error());
...
<!-- /.navbar -->
                ...
                <!-- ."main-bar -->
                    <div class="main-bar">
                        <h3><i class="fa fa-calendar"> </i> Announcements</h3>
                  </div>
                    <!-- /.main-bar -->
            </header>
                <!-- end header.head -->
                     ...
                     <div class="col-lg-6">
                       <div class="box">
                        ...
                        <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                               <div class="col-lg-12">
                               <textarea name="MTXT_UpdateData" id="MTXT_UpdateData" class="validate[required] form-control" placeholder="Write your news..."></textarea>
                               </div>
                            </div>
                            <div class="form-group">
                               <div class="col-lg-12">
...
-->        <script src="../assets/lib/jquery-1.9.1.min.js"></script>
        ...
        $(function() {
           ...
           /*$( 'textarea#MTXT_UpdateData' ).ckeditor({width:'99.6%', height: '350px'});*/
        });
