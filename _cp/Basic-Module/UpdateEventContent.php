...
$row_eventDesc = mysql_fetch_array(mysql_query("SELECT * FROM `latest_news_content` WHERE `LE_C_Slno` = '".$_GET['contid']."'"));
	...
	if(isset($_POST['BTN_UpdEventData']))
	{
			if($_POST['RBTN_EventType'] == "Text")
			{
				...
				{
					unlink("../../Upl_Images/EventImage/Thumbnail/".$row_eventDesc['LE_C_Content']);
					unlink("../../Upl_Images/EventImage/Main/".$row_eventDesc['LE_C_Content']);
				}
			}
			else if($_POST['RBTN_EventType'] == "Image")
			{
			$description = "Event_".$_GET['event_id']."_".time().".jpg";
			upload_image($_FILES['IMG_event'], "../../Upl_Images/EventImage/Thumbnail/", $description, 154, 116, "no");
			upload_image($_FILES['IMG_event'], "../../Upl_Images/EventImage/Main/", $description, 600, 400, "yes");
			}
...
<!-- /.navbar -->
                ...
                <!-- ."main-bar -->
                    <div class="main-bar">
                        <h3><i class="fa fa-dashboard"></i> Update Event Content</h3>
                  </div>
                    <!-- /.main-bar -->
            </header>
                <!-- end header.head -->
                    ...
                    <div class="row">
                     <div class="col-lg-12">
                       <div class="box">
                        ...
                        <h5><?php echo $event_row['LE_Heading'];?></h5>
                      </header>
                         <div class="body">
                           <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                             <div class="form-group">
                               <label class="control-label col-lg-2">Date</label>
                               <div class="col-lg-5 text-info" style="padding-top: 7px;"><?php echo $event_row['LE_Date']; ?></div>
                             </div>
                             <div class="form-group">
    ...
    Image</label>
                             ...
                             <div class="block">
                             <div id="textbox" style="display: <?php if($row_eventDesc['LE_C_Type']=="Text") echo 'block'; else echo 'none'; ?>;">
                            ...
                            <?php 
							  if($row_eventDesc['LE_C_Type']=="Image")
                              { 
                              $img_dir="../../Upl_Images/EventImage/Main/";
                              ?>
                              <div class="body">
                            ...
                            <label class="col-lg-2"></label>
                              <input type="submit" name="BTN_UpdEventData" id="BTN_UpdEventData" value="Save" class="btn btn-primary col-lg-2" />
                              <label class="col-lg-1"></label>
                            <a class="btn btn-warning col-lg-2" style="padding:4px 0px 4px 0px" href="EventDetail.php?event_id=<?php echo $_GET['event_id']; ?>">Click To Back</a>
                          </div>
