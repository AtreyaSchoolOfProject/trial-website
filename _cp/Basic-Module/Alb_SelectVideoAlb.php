...
$res_alb = mysql_query("SELECT * FROM `media_album` WHERE `visibility` = '1'");
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="box">
                         ...
                         <tr>
                         <td align="center">
						 <?php echo "We didn't found any Album. "."<a href='Alb_NewVideo.php'>Click Here</a> to create a new Album" ; ?>
                         ...
                         <?php
                          ...
                          <td>
							...
							{
						?>
                         <table width="16.3%" align="left" cellpadding="10" class="table-bordered" style="margin: 0.5%">
                         <tr>
                         <td height="120" colspan="3" align="center">
                           <a href="<?php echo "Alb_UplNewVideo.php?upload=true&alb=".$row_alb['slno']; ?>"><img src="<?php echo "../../Upl_Images/Gallery/Thumbnail/".$row_alb['album_screen']; ?>" alt="<?php echo $row_alb['album_name']; ?>" /></a></td>
                         </tr>
                         <tr>
                           <td colspan="3" align="center"><a href="<?php echo "Alb_UplNewVideo.php?upload=true&alb=".$row_alb['slno']; ?>"><?php echo $row_alb['album_name']; ?></a></td>
                         </tr>
