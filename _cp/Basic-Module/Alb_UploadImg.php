...
$res_alb = mysql_query("SELECT * FROM album_name WHERE `AN_OI_OrganisationID` = '".$_SESSION['OI_OrganisationID']."'");
                      ...
                      <div class="col-lg-12">
						...
						?>
                         ...
                         <td height="120" colspan="3" align="center">
                           <a href="<?php echo "Alb_UplImg2.php?upload=true&alb=".$row_alb['AN_ID']; ?>"><img src="<?php echo $dir."Thumbnail/".$row_alb['AN_Image']; ?>" alt="<?php echo html_entity_decode($row_alb['AN_Name'], ENT_QUOTES, "UTF-8"); ?>" /></a></td>
                         </tr>
                         <tr>
                           <td colspan="3" align="center"><a href="<?php echo "Alb_UplImg2.php?upload=true&alb=".$row_alb['AN_ID']; ?>"><?php echo html_entity_decode($row_alb['AN_Name'], ENT_QUOTES, "UTF-8"); ?></a></td>
                         </tr>
