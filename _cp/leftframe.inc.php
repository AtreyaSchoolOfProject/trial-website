...
<ul id="menu" class="collapse">
    ...
    <li class="panel "><a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav"><i class="fa fa-picture-o"></i> Gallery<span class="pull-right"><i class="fa fa-angle-left"></i></span></a>
        <ul class="collapse" id="component-nav">
            <li><a href="Basic-Module/GalleryIndex.php?photo"><i class="fa fa-camera">&nbsp;</i>&nbsp;Photo</a></li>
            <li><a href="Basic-Module/GalleryIndex.php?video"><i class="fa fa-video-camera">&nbsp;</i>&nbsp;Video</a></li>
           <!--<li class=""><a href="Basic-Module/Alb_CreateNewAlbum.php">New Album</a></li>
    ...
    data-target="#form-update"><i class="fa fa-caret-square-o-right"></i> Media Resource<span class="pull-right"><i class="fa fa-angle-left"></i></span></a>
        <ul class="collapse" id="form-update">
            <li class=""><a href="Basic-Module/UploadNoticeUpdate.php">Notice</a></li>
            <li class=""><a href="Basic-Module/UploadAnnouncement.php">Announcements</a></li>
            <li class=""><a href="Basic-Module/Upload_PressRelease.php">Press Release</a></li>
            <li class=""><a href="Basic-Module/Upload_Infographic.php">Infographic</a></li>
        </ul>
    </li>
   ...
   <li class="panel "><a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle collapsed"
    data-target="#form-nav"><i class="fa fa-flag"></i> Events<span class="pull-right"><i class="fa fa-angle-left"></i></span></a>
        <ul class="collapse" id="form-nav">
            <li class=""><a href="Basic-Module/UploadEventHeading.php">Social Initiatives</a></li>
            <li class=""><a href="Basic-Module/ListEvents.php">View All</a></li>
        </ul>
    </li>
    ...
    <li class="panel "><a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#sms"><i class="fa fa-envelope"></i> SMS <span class="pull-right"><i class="fa fa-angle-left"></i></span></a>
	  <ul class="collapse" id="sms">
		  <li class=""><a href="Basic-Module/User-List.php">Send SMS</a></li>
		  <li class=""><a href="Basic-Module/Message-List.php">Sent Message(s) List</a></li>
		</ul>
	</li>
    <li class=""><a href="Basic-Module/MemberList.php"><i class="fa fa-group"></i> &nbsp;Member List</a></li>
	<li class=""><a href="Basic-Module/MailViewList.php"><i class="fa fa-list"></i> &nbsp;Quick Message(s)</a></li>
    <!--<li class="panel "><a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#dashboard-prod"><i class="fa fa-envelope"></i> Contacts<span class="pull-right"><i class="fa fa-angle-left"></i></span></a>
      <ul class="collapse" id="dashboard-prod">
      	  <li class=""><a href="Basic-Module/MemberList.php">Member List</a></li>
          <li class=""><a href="Basic-Module/MailViewList.php">Mails</a></li>
        </ul>
    </li>-->
        
    <!--<li class="panel "><a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle collapsed"
    data-target="#form-menunav"><i class="fa fa-file"></i> Menu Content<span class="pull-right"><i class="fa fa-angle-left"></i></span></a>
        <ul class="collapse" id="form-menunav">
            <li class=""><a href="Basic-Module/UploadMenu.php">Upload Menu Content</a></li>
            <li class=""><a href="Basic-Module/UploadMenuDescription.php">Manage Menu Content</a></li>
        </ul>
    </li>-->
</ul>
<!-- /#menu -->
